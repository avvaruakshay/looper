...
const repeatAbundanceBasicOptions  = {
    ...
    toolbox: {
        right: 20,
        feature: {
          saveAsImage: {  title: 'Save as PNG', show: true,  type: 'png',  name: `${data.info.seqInfo.File_name}_RepeatAbundance` },
...
const lengthAbundanceBasicOptions  = {
    ...
    toolbox: {
        right: 20,
        feature: {
          saveAsImage: {  title: 'Save as PNG', show: true,  type: 'png',  name: `${data.info.seqInfo.File_name}_lengthAbundance` 
          },
          dataView: {  title: 'View data',  readOnly: true,  lang: ['Data View', 'Go  back'] 
          },
        }
...
const kmerChartOptions = {
    ...
    toolbox: {
        right: 20,
        feature: {
          saveAsImage: {  title: 'Save as PNG', show: true,  type: 'png',  name: `${data.info.seqInfo.File_name}_KmerDistribution` 
          },
          dataView: {  title: 'View data',  readOnly: true,  lang: ['Data View', 'Go  back'] 
          },
        }
